...
/**
 * Clase de prueba de la clase Wheel
 *
...
public class WheelTest
{
     ...
     * 1- Valores son congruentes -> Cambiar los valores
     * 2- Valores no son congruentes -> Valores por defecto
     */
    /**
     * 1- Valores son congruentes -> Cambiar los valores
     */
    @Test       //test del primer escenario
    public void testConstructorWithParamsOkay()
    {
    ...
    public void testConstructorWithParamsNotOkay()
    {
        Wheel wheel1 = new Wheel(1100,1500);
        assertNotNull(wheel1);
        assertEquals(1000.0, wheel1.getMaxPressure(), 0.1);
        assertEquals(900.0, wheel1.getPressure(), 0.1);
    }
    /*
