...
public class Plane
{
    ...
    public static final int MAX_FUEL = 125000;
    ...
    private int distance;           //distancia que debe volar el avión
    private int Consumption;        //consumo del avión
    private int X;                  //combustible necesario para el viaje
    ...
    /**
     * Constructor 6 for objects of class Plane
     * 
     */
     ...
     *
     * @param distancia que va a volar
     * @return si el avión volará o no
     */
    public String fly(int distance)
    {
        if(distance>=MIN_DISTANCE && getFuel()>=calculateFuelConsumption()){
            this.fuel=fuel-calculateFuelConsumption();
            return "FLY-OK";
        }else if(distance>=MIN_DISTANCE && fuel<calculateFuelConsumption()){
            X = calculateFuelConsumption()-getFuel();
            return "REFUEL X";
        }else{
            return "FLY FAILED";
        }
    ...
    /**
     * Método que calcula el consumo del avión
     *
     * 
     */
    ...
    {
        if(identifier== 'Z'){
          Consumption=10*distance;  
        }else{
          Consumption=50*distance;
        }
        return Consumption;
    }
