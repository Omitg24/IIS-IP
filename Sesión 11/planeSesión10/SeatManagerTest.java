...
public class SeatManagerTest
{
     ...
     * Positivos:
     * 1- Lista no contiene hombres -> devuelve 0 y no borra ninguno
     * 2- Lista con hombres y mujeres -> devuelve el número de hombres y los borra de la lista
     * 
     * Negativos:
     * 3- Lista vacía -> Excepción o devolver 0 (según nos indique el enunciado)
     * 4- null en lugar de lista -> Excepción 
     * 5- Lista con elementos null -> Excepción
     */
    ...
    public void testRemoveMalesMenAndWomen(){
        SeatManager manager1 = new SeatManager(4,5);
        ...
        assertEquals(4,manager1.removeMales(list));        
        int men= manager1.removeMales(list);
        assertEquals(4,men);
        
        for (Person person : list){
            assertEquals(Person.GENDER_MALE, person.getGender());
        }
